...
public class ShowThisCarBookingHistory extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String car_id=intentq.getStringExtra("car_id");
        String car_name=intentq.getStringExtra("car_name");
        setContentView(R.layout.activity_show_this_car_booking_history);

        TextView txt=(TextView)findViewById(R.id.bookHisTtl);
        txt.setText("Booking history of "+car_name+"");
...
//            ft.addToBackStack(null);
            ...
            String serverURL = "http://luxscar.com/luxscar_app/show_this_car_books.php?car_id="+car_id;
    ...
    public void loadHosts(final ArrayList<Car_lists> newParents)
    {
        ...
        for(int i=0;i<parents.size();i++){
            ...
            View vi= LayoutInflater.from(getApplicationContext()).inflate(R.layout.singlethiscarhistry,null);
